	...
	setTimeout(function(){
        ...
        for (var i = 0; i < chunkSize; i++) {
			...
			describe('Tests for patient details API', function() {   			
				...
				it('should fetch the reports for the given status and "limit" parameter', function (done) {
					this.timeout(200000);					
					var req = request(app).get('/api/getreportlist/status/publish/page/1');
					req.cookies = Cookies;
					  req
					  .set('Accept', 'application/json')					 					 					  
					  .send({'statysId': 'publish', 'pagenum': 1})
