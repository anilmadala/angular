	...
	setTimeout(function(){
        ...
        for (var i = 0; i < chunkSize; i++) {
			...
			describe('Tests for patient details API', function() {   			
				...
				it('should fetch the reports for the given report type and limit setting', function (done) {
					this.timeout(200000);					
					var req = request(app).get('/api/getreportlist/search/dfr/page/1');
					req.cookies = Cookies;
					  req
					  .set('Accept', 'application/json')					 					 					  
					  .send({'searchId': 'dfr', 'pagenum': 1})
